...
NUM_ENV_STEPS_SAMPLED_FOR_EVALUATION_THIS_ITER = "num_env_steps_sampled_for_evaluation_this_iter"
...
NUM_TRAINING_STEP_CALLS_SINCE_LAST_SYNCH_WORKER_WEIGHTS = "num_training_step_calls_since_last_synch_worker_weights"
